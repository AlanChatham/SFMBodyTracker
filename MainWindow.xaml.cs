...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private class quaternionPoint
        {
            public long time { get; set; }
            public Vector4 value { get; set; }

            public quaternionPoint(long t, Vector4 v)
            {
                time = t;
                value = v;
            }
        ...
        {
            public List<quaternionPoint> HipCenter;
            public List<quaternionPoint> Spine;
            public List<quaternionPoint> ShoulderCenter;
            public List<quaternionPoint> Head;
            public List<quaternionPoint> ShoulderLeft;
            public List<quaternionPoint> ElbowLeft;
            public List<quaternionPoint> WristLeft;
            public List<quaternionPoint> HandLeft;
            public List<quaternionPoint> ShoulderRight;
            public List<quaternionPoint> ElbowRight;
            public List<quaternionPoint> WristRight;
            public List<quaternionPoint> HandRight;
            public List<quaternionPoint> HipLeft;
            public List<quaternionPoint> KneeLeft;
            public List<quaternionPoint> AnkleLeft;
            public List<quaternionPoint> FootLeft;
            public List<quaternionPoint> HipRight;
            public List<quaternionPoint> KneeRight;
            public List<quaternionPoint> AnkleRight;
            public List<quaternionPoint> FootRight;

            public rotationData()
            {
                HipCenter = new List<quaternionPoint>();
                Spine  = new List<quaternionPoint>();
                ShoulderCenter = new List<quaternionPoint>();
                Head = new List<quaternionPoint>();
                ShoulderLeft = new List<quaternionPoint>();
                ElbowLeft = new List<quaternionPoint>();
                WristLeft = new List<quaternionPoint>();
                HandLeft = new List<quaternionPoint>();
                ShoulderRight = new List<quaternionPoint>();
                ElbowRight = new List<quaternionPoint>();
                WristRight = new List<quaternionPoint>();
                HandRight = new List<quaternionPoint>();
                HipLeft = new List<quaternionPoint>();
                KneeLeft = new List<quaternionPoint>();
                AnkleLeft = new List<quaternionPoint>();
                FootLeft = new List<quaternionPoint>();
                HipRight = new List<quaternionPoint>();
                KneeRight = new List<quaternionPoint>();
                AnkleRight = new List<quaternionPoint>();
                FootRight = new List<quaternionPoint>(); 
            }
        }

        // Variables to track and store data
        Stopwatch stopwatch = new Stopwatch();
        private bool isRecording = false;
        private rotationData skeletonData;
